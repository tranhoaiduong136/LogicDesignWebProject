    <img id="idle-datapath" src ='tool/datapath/single-cycle-lw.png' class='img-fluid mx-auto d-block mb-5' alt="mips-single-cycle-datapath-load-word"/>
    <p class="d-flex flex-column justify-content-center text-center py-5 my-5">&#12298; MIPS Single-cycle Datapath of instruction &lsquo;lw&rsquo; &#12299;</p>
        ...
        <div class="d-flex flex-column justify-content-center text-left mx-5 px-5">
            <div class="d-block">
                ...
                <div id="instruction-explanation" class="mb-5">
                    ...
                    <ul class="list-group list-group-flush px-auto mx-auto">
                        <li class="list-group-item">Instruction name: Load word / lw &#36;rt, imm(&#36;rs)
                        </li>
                        <li class="list-group-item">Operation: R[rt] = M[R[rs]+SignExtImm] </li>
