    <img id="idle-datapath" src ='tool/datapath/single-cycle-i.png' class='img-fluid mx-auto d-block mb-5' alt="mips-single-cycle-datapath-i-type-addi-slti"/>
    <p class="d-flex flex-column justify-content-center text-center py-5 my-5">&#12298; MIPS Single-cycle Datapath of instruction &lsquo;addi / slti&rsquo; &#12299;</p>
        ...
        <div class="d-flex flex-column justify-content-center text-left mx-5 px-5">
            <div class="d-block">
                    ...
                    <ul class="list-group list-group-flush px-auto mx-auto">
                        ...
                        <li class="list-group-item"> Execution flow <br> &#129170;
                            ...
                            <ol class="list-group list-group-numbered">
                                ...
                                <li class="list-group-item border-0">Select the sign-extended immediate as the second input of ALU and perform necessary ALU operation.</li>
                ...
                <div id="ext-explanation" class="mb-5">
                    ...
                    <ul class="list-group list-group-flush px-auto mx-auto">
                        <li class="list-group-item">The existing components of the initial datapath is sufficient to implement these instructions.
                        However, the existing 2-bit ALUOp signal can only specify add (00) for load / store, subtract (01) for branch, operations
                            ...
                            <caption>Modified ALU Control decoder - 2 rows added</caption>
                                ...
                                <tbody>
                                    ...
                                    <tr class="table-success">
                                        ...
                                        <td>0111 (set on less than for slti)</td>
                                    </tr>
                                </tbody>
                            </table>
                        </li>
